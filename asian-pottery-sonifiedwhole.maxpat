...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 805.0, 774.0, 132.0, 22.0 ],
					"style" : "",
					"text" : "read une427.jpg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 827.0, 731.0, 82.0, 22.0 ],
					"style" : "",
					"text" : "prepend read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 795.0, 678.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 854.0, 666.0, 133.0, 22.0 ],
					"style" : "",
					"text" : "unpack name 0 0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 805.0, 571.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 853.0, 571.0, 160.0, 36.0 ],
					"style" : "",
					"text" : "0 une427.jpg 888 7676 776 777 888"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 856.0, 430.0, 62.5, 62.5 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 863.0, 529.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "counter 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 702.0, 891.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 781.0, 100.0, 150.0, 34.0 ],
					"style" : "",
					"text" : "WHAT EACH ELEMENT DOES:"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 573.0, 641.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 502.0, 707.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "lores~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 507.0, 637.440552, 36.0, 22.0 ],
					"style" : "",
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 507.0, 590.007019, 54.0, 22.0 ],
					"style" : "",
					"text" : "$1 1000"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 507.0, 548.0, 116.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 781.0, 141.0, 150.0, 34.0 ],
					"style" : "",
					"text" : "Calcium: exploit the high fluctuations somehow..."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 781.0, 177.0, 150.0, 34.0 ],
					"style" : "",
					"text" : "Sodium: frequency cutoff filter."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 781.0, 353.0, 150.0, 34.0 ],
					"style" : "",
					"text" : "Cerium: controls the amplitude of the output"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 781.0, 292.0, 150.0, 48.0 ],
					"style" : "",
					"text" : "Barium: frequency is directly mapped to the sawtooth sound."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 781.0, 229.0, 150.0, 48.0 ],
					"style" : "",
					"text" : "Potassium: Play a given sound for values over 20000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 656.0, 409.0, 32.5, 20.0 ],
					"style" : "",
					"text" : "Ca"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 573.0, 409.0, 22.0, 20.0 ],
					"style" : "",
					"text" : "K"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 506.5, 409.0, 49.5, 20.0 ],
					"style" : "",
					"text" : "Na"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 437.5, 409.0, 60.0, 20.0 ],
					"style" : "",
					"text" : "Ce"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 378.5, 409.0, 50.0, 20.0 ],
					"style" : "",
					"text" : "Ba"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 433.0, 799.0, 142.0, 20.0 ],
					"style" : "",
					"text" : "Play the resulting sound"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 393.5, 953.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 393.5, 788.0, 22.0, 140.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 378.5, 493.0, 39.0, 22.0 ],
					"style" : "",
					"text" : "saw~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 430.5, 329.0, 116.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 418.5, 284.0, 50.5, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 16.0, 77.0, 77.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 751.25, 91.0, 230.75, 305.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.25, 759.0, 307.75, 374.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 778.0, 235.0, 249.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 372.5, 7.0, 353.0, 433.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
